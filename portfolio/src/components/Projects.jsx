...
const Projects = () => {
  ...
  useEffect( ()=> {
    ...
    width > 768 ? animateWithGsapTimeline(tmain,'.projects',{ y:-50,opacity:1,duration:2,stagger:0.5},{start:'20% 80%',end:'50% 80%',scrub:0.6}) : animateWithGsapTimeline(tmain,'.projects',{ y:-20,opacity:1,duration:2,stagger:0.5},{start:'5% 90%',end:'10% 80%',scrub:0.9})
