  ...
  return (
    <section  id='about'>
      <div className={` wholepage w-full ${width>768 ? 'opacity-0' : ''}`}>
        ...
        <div className={`normText text-[15px] text-newgrey md:text-xl   md:mr-5 edu ${width<768? 'opacity-0 ':''}`}  >B.Tech Computer Science And Engineering<br />
