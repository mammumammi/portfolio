...
const About = () => {
  ...
  return (
    <section className='about  w-full'>
        ...
        <motion.div className='content normText text-1xl mr-5 w-[40vw] whitespace-pre-line' initial={{visibility:'hidden',opacity:0}} whileInView={{visibility:'visible',opacity:1}} transition={{duration: 1}}  >{text}<Cursor />
        </motion.div>
